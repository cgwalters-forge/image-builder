...
// A UKI has no root= karg and relies on systemd-gpt-auto-generator to find
// the root filesystem, so its root partition needs the DPS root type. Other
// images keep the generic type of the YAML definitions.
